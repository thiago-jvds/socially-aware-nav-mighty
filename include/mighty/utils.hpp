...
/**
 * @brief Convert a float vector representing the mode probabilities to an Eigen::Vector3d.
 *  @param msg_mu Input mode probabilities as a float vector (size 3).
 *  @return Eigen::Vector3d representing the mode probabilities.
 */
